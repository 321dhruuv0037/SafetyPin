...
class _MyBusstopsState extends State<MyBusstops> {
  ...
  Future<void> _launchGoogleMaps() async {
    ...
    if (currentPosition == null) {
      url = "https://www.google.com/maps/search/Bus+Stops+near+me";
    } else {
      url =
          "https://www.google.com/maps/search/Bus+Stops/@${currentPosition!.latitude},${currentPosition!.longitude},15z";
    }
    try {
